...
params.bodyLength = 0.40;   % nose-to-tail top panel length
params.bodyWidth  = 0.18;   % side-to-side panel width
params.bodyHeight = 0.10;   % top panel thickness used for visuals only

% Hip locations relative to body center (x forward, y left, z up)
params.hipForwardX = 0.16;  % longitudinal distance of hips from center
params.hipLateralY = 0.09;  % lateral distance of hips from center
params.hipHeightZ  = -0.09; % hip joint height below body center

% Leg link lengths (planar sagittal IK)
params.upperLen = 0.09;   % femur
params.lowerLen = 0.11;   % tibia
